...
<center>
    <form action="/comments/battle/<?php echo $owner_id; ?>" method="POST" class="well" style="margin: 25px 0 0 0;">
        ...
        <textarea name="text" class="span3" placeholder="Текст коментария"><?php echo isset($text) ? $text : ''; ?></textarea>
        <div class="separator"></div>
